...
namespace Resturant_Mangement_System {
    ...
    public partial class RestaurantDataSet3 : global::System.Data.DataSet {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public staffRow AddstaffRow(string sName, string sPhone, string sRole, string username, string upass) {
        ...
        public partial class staffRow : global::System.Data.DataRow {
            ...
            public string upass {
                get {
                    return ((string)(this[this.tablestaff.upassColumn]));
                }
                set {
                    this[this.tablestaff.upassColumn] = value;
                }
            }
...
namespace Resturant_Mangement_System.RestaurantDataSet3TableAdapters {
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[staff] WHERE (([staffID] = @Original_staffID) AND ((@IsNull_sName = 1 AND [sName] IS NULL) OR ([sName] = @Original_sName)) AND ((@IsNull_sPhone = 1 AND [sPhone] IS NULL) OR ([sPhone] = @Original_sPhone)) AND ((@IsNull_sRole = 1 AND [sRole] IS NULL) OR ([sRole] = @Original_sRole)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ([upass] = @Original_upass))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[staff] ([sName], [sPhone], [sRole], [username], [upass]) VALUE" +
                "S (@sName, @sPhone, @sRole, @username, @upass);\r\nSELECT staffID, sName, sPhone, " +
                "sRole, username, upass FROM staff WHERE (staffID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[staff] SET [sName] = @sName, [sPhone] = @sPhone, [sRole] = @sRole, [username] = @username, [upass] = @upass WHERE (([staffID] = @Original_staffID) AND ((@IsNull_sName = 1 AND [sName] IS NULL) OR ([sName] = @Original_sName)) AND ((@IsNull_sPhone = 1 AND [sPhone] IS NULL) OR ([sPhone] = @Original_sPhone)) AND ((@IsNull_sRole = 1 AND [sRole] IS NULL) OR ([sRole] = @Original_sRole)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ([upass] = @Original_upass));
SELECT staffID, sName, sPhone, sRole, username, upass FROM staff WHERE (staffID = @staffID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Resturant_Mangement_System.Properties.Settings.Default.RestaurantConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT staffID, sName, sPhone, sRole, username, upass FROM dbo.staff";
        ...
        public virtual int Fill(RestaurantDataSet3.staffDataTable dataTable) {
        ...
        public virtual RestaurantDataSet3.staffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RestaurantDataSet3.staffDataTable dataTable = new RestaurantDataSet3.staffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RestaurantDataSet3.staffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_staffID, string Original_sName, string Original_sPhone, string Original_sRole, string Original_username, string Original_upass) {
            ...
            if ((Original_upass == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_upass));
            }
        ...
        public virtual int Insert(string sName, string sPhone, string sRole, string username, string upass) {
            if ((sName == null)) {
            ...
            if ((upass == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(upass));
            }
        ...
        public virtual int Update(string sName, string sPhone, string sRole, string username, string upass, int Original_staffID, string Original_sName, string Original_sPhone, string Original_sRole, string Original_username, string Original_upass, int staffID) {
            if ((sName == null)) {
            ...
            if ((upass == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(upass));
            }
            ...
            if ((Original_sRole == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_sRole));
            }
            if ((Original_username == null)) {
            ...
            if ((Original_upass == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_upass));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string sName, string sPhone, string sRole, string username, string upass, int Original_staffID, string Original_sName, string Original_sPhone, string Original_sRole, string Original_username, string Original_upass) {
            return this.Update(sName, sPhone, sRole, username, upass, Original_staffID, Original_sName, Original_sPhone, Original_sRole, Original_username, Original_upass, Original_staffID);
        }
    }
